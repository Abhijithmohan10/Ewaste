...
$qry="select * from schedule_employee e inner join selling_request r inner join customers c on e.req_id=r.request_id and e.emp_id='$emp_id' and e.sch_status='assigned' and r.req_status='progressed' and c.email=r.comp_email";
...
foreach($data as $row)
{
  ...
  ?>              <tr>
				...
				<td><a href="viewitem.php?id=<?php echo $row['request_id']?>&type=scheduled">View items</a></td>

...
$qry="select * from schedule_employee e inner join selling_request r inner join customers c on e.req_id=r.request_id and e.emp_id='$emp_id' and e.sch_status='assigned' and r.req_status='progressed' and c.cust_id=r.comp_id";
						...
						<div class="inner_content_w3_agile_info two_in">
							...
							<div class="forms-main_agileits">
								<div class="graph-form agile_info_shadow">
									<h3 class="w3_inner_tittle two"> Your Scheduled Details</h3>
									<div class="form-body">
...
foreach($data as $row)
{
  ...
  ?>              <tr>
                 ...
                 <!-- <td><?php //echo $row['price']?></td>-->
                  ...
                  <td><a href="payment.php?id=<?php echo $row['request_id']?>">Payments</a><br><a href="viewitem.php?id=<?php echo $row['request_id']?>&type=scheduled">View items</a></td>

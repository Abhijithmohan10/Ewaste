...
$qry="select * from schedule_employee e inner join selling_request r inner join customers c on e.req_id=r.request_id and e.emp_id='$emp_id' and e.sch_status='expired' and r.req_status!='pending' and c.cust_id=r.comp_id";

					...
					<div class="inner_content_w3_agile_info two_in">
							...
							<div class="forms-main_agileits">
								<div class="graph-form agile_info_shadow">
									...
									<div class="form-body">
										<form action="codes/employee_exe.php?action=insert" method="post">
											<div class="col-md-6">
											...
											<div class="form-group">
												...
												<input type="text" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Invalid Email Format" class="form-control" id="exampleInputPassword1" required="" placeholder="" name="emp_email">
											</div>

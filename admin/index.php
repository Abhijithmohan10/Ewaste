				...
				<div class="inner_content">
					...
					<!-- /agile_top_w3_grids-->
					   <div class="agile_top_w3_grids">
					          <ul class="ca-menu">
									<li>
										<a href="ewastecategory.php">
											
											<i class="fa fa-building-o" aria-hidden="true"></i>
											<div class="ca-content">
										
												<h3 class="ca-sub">EWaste Category</h3>
											</div>
										</a>
									</li>
									<li>
										<a href="employee.php">
										  <i class="fa fa-user" aria-hidden="true"></i>
											<div class="ca-content">
												...
												<h3 class="ca-sub one">Employee</h3>
											</div>
										</a>
									</li>
									<li>
										<a href="Company_category.php">
											...
											<div class="ca-content">
												...
												<h3 class="ca-sub two">Company Category</h3>
											</div>
										</a>
									</li>
									<li>
									...
									<a href="view_customer.php?type=active">
											<i class="fa fa-clone" aria-hidden="true"></i>
											<div class="ca-content">
												
												<h3 class="ca-sub four">Approved Customer</h3>
											</div>
										</a>
										</li>
										<li>
										<a href="report_home.php?type=new">
											...
											<div class="ca-content">
												...
												<h3 class="ca-sub three">Reports</h3>
											</div>
										</a>
									</li>

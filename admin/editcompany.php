													...
													<div class="forms-main_agileits">
															...
															<div class="graph-form agile_info_shadow">
															 <h3 class="w3_inner_tittle two">Company Category </h3>
																	<div class="form-body">
																		<form action="codes/companycategory_exe.php?action=update" method="post"  action="codes/edit_company_exe">
																		
																			<div class="form-group"> 
																				<label for="exampleInputEmail1">Category</label> 
																				<input type="text" class="form-control" id="exampleInputEmail1" pattern="[a-zA-Z ]+" title="Characters only" placeholder="Enter your category name" name="cat_name" value="<?php echo $result2['cmp_cat_name']; ?>" required> 
																			 </div> 
																				<div class="form-group">
										...
										<div class="w3l-table-info agile_info_shadow">
											...
											<tbody>
											  ...
											  <tr>
												...
												<td><a href="codes/companycategory_exe.php?action=delete&cmp_cat_id=<?php echo $r['cmp_cat_id'];?>" onClick="return confirm('Are You Sure want to delete?');"> DELETE </a></td>

...
$qry="select * from schedule_employee e inner join selling_request r inner join customers c on e.req_id=r.request_id and  e.sch_status='update' and r.req_status='progressed' and c.email=r.comp_email";
						...
						<div class="inner_content_w3_agile_info two_in">
							...
							<div class="forms-main_agileits">
								<div class="graph-form agile_info_shadow">
									<h3 class="w3_inner_tittle two"> Selling Details</h3>
									<div class="form-body">

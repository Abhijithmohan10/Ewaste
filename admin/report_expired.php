...
$newtable="select * from selling_request r inner join customers c inner join schedule_employee e inner join employee y on r.comp_email=c.email  where r.req_status='progressed' and e.req_id=r.request_id and e.sch_status='expired' and e.emp_id=y.emp_id";
...
{
?>    
               <h3 class="w3_inner_tittle two"> Expired E-Waste Details </h3>   

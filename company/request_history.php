...
$comp_id=$obj->GetSingleData($qwey);
 ...
 $qry="select * from selling_request r inner join request_items i on r.request_id=i.req_id where r.comp_email='$ses' and r.req_status!='collected' and r.req_status!='send'";
